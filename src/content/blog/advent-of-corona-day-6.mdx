...
<Image src={aoc6_1} alt="Ghidra import dialog" />

#### Analyze it

Just analyze all.

<Image src={aoc6_2} alt="Ghidra analyze dialog" />
...
<Image src={aoc6_3} alt="Main function in Ghidra" />
...
<Image src={aoc6_4} alt="Ghidra variable redefinition" />
