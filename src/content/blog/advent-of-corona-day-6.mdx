...
subtitle: Solving a binary reversing challenge with Ghidra
date: 2020-03-27
tags: [reversing, advent-of-corona, ctf]
---

import BlogImage from '../../components/BlogImage.astro';
import aoc6_1 from '../../img/aoc6-1.PNG';
import aoc6_2 from '../../img/aoc6-2.PNG';
import aoc6_3 from '../../img/aoc6-3.PNG';
import aoc6_4 from '../../img/aoc6-4.PNG';
...
<BlogImage src={aoc6_1} alt="Ghidra import dialog" caption="Importing a binary file into Ghidra" />

#### Analyze it

Just analyze all.

<BlogImage src={aoc6_2} alt="Ghidra analyze dialog" caption="Running the automatic analysis in Ghidra" />
...
<BlogImage src={aoc6_3} alt="Main function in Ghidra" caption="Viewing the decompiled main function" />
...
<BlogImage src={aoc6_4} alt="Ghidra variable redefinition" caption="Redefining variables to improve code readability" />
