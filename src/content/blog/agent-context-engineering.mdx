...
image: /img/context-eng/intent-agent.png
---
...
import allAgents from '../../../src/img/context-eng/all-agents-chart.png';
...
You can see that there are some Python f-string placeholders, which are the dynamic parts that change in each iteration of the agent. If you want to see all the details, [here's the code for the intent agent prompt](https://github.com/desplega-ai/context-engineering/blob/main/src/agents/intent_prompts.py).
...
<BlogImage src={allAgents} alt="Comparison between the three agents" caption="Comparison between the three agents" width={700} />
