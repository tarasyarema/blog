---
title: Context Engineering for AI Agents in 2026
subtitle: Why controlling your LLM context matters more than code quality
date: 2025-11-08
...
To which I answered that I would write a blog post about this topic. So... here it is!
...
In particular, I wanted to summarize the three strategies analyzed:

- **Raw**: Simple dump everything. The more you dump into it the less you will get out of it. That's why Claude Code has auto-compactification.
- **Summarization**: Like the broken telephone game. The more you summarize, the more you lose. After multiple summaries, you don't even know what the original task is.
- **Intent**: Simple, but effective. The more you control the context, the better the results. It will grow, so it has its limits, yet more controllable and higher ceiling than the other two.
