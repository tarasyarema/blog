---
title: A (deep) dive into Context Engineering
subtitle: Why context engineering is critical, and how to master it.
date: 2025-11-08
tags: [ai, agents, context-engineering, llm, langchain]
---
...
**An agent is a fully/human supervised process that uses LLMs and a set of heterogeneous tools to achieve a specific non-trivial task.**
