...
subtitle: A lesson from the Stripe API and Go marshaling
date: 2021-03-01
tags: [go-lang, pointers, programming]
---

import BlogImage from '../../components/BlogImage.astro';
import stripeDrama from '../../img/stripe-drama-1.PNG';
...
To illustrate, let's consider that we want to get a specific coupon, for that
...
<BlogImage src={stripeDrama} alt="Small commit showing changes" caption="An example of the pointer conversion changes made to the Stripe Go package" />
